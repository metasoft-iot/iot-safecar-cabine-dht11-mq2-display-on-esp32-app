...
/**
 * @brief Client for sending telemetry data to SafeCar Edge Service
 * 
...
public:
    ...
    /**
     * @brief Send telemetry data from CABINA sensors to Edge Service
     * @param temperature Cabin temperature in Celsius (DHT11)
     * @param humidity Cabin humidity in percent (DHT11)
     * @param gasValue Gas concentration from MQ2 sensor
     * @param latitude GPS latitude (NEO6M)
     * @param longitude GPS longitude (NEO6M)
     * @return true if data sent successfully
     */
    bool sendTelemetry(float temperature, float humidity, int gasValue, 
